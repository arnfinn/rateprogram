...
1554,1557,1560,1563,1566,1571,1573,1576) then BoHF=8;
	...
	* For eldreatlaset: slått sammen Lovisenberg og Diakonhjemmet til Indre Oslo (BoHF = 30);
	else if bydel in (030101,030102,030104,030116) then BoHF=30;/*Lovisenberg*/
	else if bydel in (030105,030106,030107) then BoHF=30;/*Diakonhjemmet*/
end;
